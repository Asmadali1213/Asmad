...
\033[1;92mAuther\033[1;93m: Asmad Ali

\033[1;92mfb\033[1;93m: Asmad Ali
...
def crack():
    ...
    print '\x1b[1;0m 1. \033[1;96mClone 3 Links\033[0m \n 2. \033[1;96mClone Single id\033[0m' ##Thanks Asmad Ali.& Also Salman Bro
...
def crack_select():
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;31m[NAME-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks Asmad Ali.& Also Salman Bro
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##Thanks Asmad Ali & Also Salman Bro
...
#Thanks Asmad Ali & Also Salman Bro
